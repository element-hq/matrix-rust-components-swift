 ...
 */
public 
enum QrCodeLoginError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_matrix_sdk_checksum_method_oauthauthorizationdata_login_url() != 7277) {
