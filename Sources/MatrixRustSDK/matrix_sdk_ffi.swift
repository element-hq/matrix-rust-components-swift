...
open func buildWithQrCode(qrCodeData: QrCodeData, oidcConfiguration: OidcConfiguration, progressListener: QrLoginProgressListener)async throws  -> Client {
    return
        try  await uniffiRustCallAsync(
            ...
            freeFunc: ffi_matrix_sdk_ffi_rust_future_free_pointer,
            liftFunc: FfiConverterTypeClient.lift,
            errorHandler: FfiConverterTypeQrLoginError.lift
        )
}
...
public enum QrCodeDecodeError {
    ...
    case Crypto(error: LoginQrCodeDecodeError
    )
}
...
public struct FfiConverterTypeQrCodeDecodeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QrCodeDecodeError {
        ...
        case 1: return .Crypto(
            error: try FfiConverterTypeLoginQrCodeDecodeError.read(from: &buf)
            )
    ...
    public static func write(_ value: QrCodeDecodeError, into buf: inout [UInt8]) {
        ...
        case let .Crypto(error):
            writeInt(&buf, Int32(1))
            FfiConverterTypeLoginQrCodeDecodeError.write(error, into: &buf)
...
public enum QrLoginError {
    ...
    case ClientBuilder(error: ClientBuildError
    )
    case SlidingSyncNotAvailable
    case OidcMetadataInvalid
    case StorageSetup(reason: String
    )
    case InvalidIntent
    case LoginError(error: QrCodeLoginError
    )
}


public struct FfiConverterTypeQrLoginError: FfiConverterRustBuffer {
    typealias SwiftType = QrLoginError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QrLoginError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        ...
        case 1: return .ClientBuilder(
            error: try FfiConverterTypeClientBuildError.read(from: &buf)
            )
        case 2: return .SlidingSyncNotAvailable
        case 3: return .OidcMetadataInvalid
        case 4: return .StorageSetup(
            reason: try FfiConverterString.read(from: &buf)
            )
        case 5: return .InvalidIntent
        case 6: return .LoginError(
            error: try FfiConverterTypeQRCodeLoginError.read(from: &buf)
            )
    ...
    public static func write(_ value: QrLoginError, into buf: inout [UInt8]) {
        switch value {
        ...
        case let .ClientBuilder(error):
            writeInt(&buf, Int32(1))
            FfiConverterTypeClientBuildError.write(error, into: &buf)
        ...
        case let .LoginError(error):
            writeInt(&buf, Int32(6))
            FfiConverterTypeQRCodeLoginError.write(error, into: &buf)
...
extension QrLoginError: Equatable, Hashable {}

extension QrLoginError: Error { }
 ...
 */
public func qrLoginErrorToHumanError(error: QrLoginError) -> HumanQrLoginError {
    return try!  FfiConverterTypeHumanQrLoginError.lift(try! rustCall() {
    uniffi_matrix_sdk_ffi_fn_func_qr_login_error_to_human_error(
        FfiConverterTypeQrLoginError.lower(error),$0
    )
})
}
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_matrix_sdk_ffi_checksum_func_qr_login_error_to_human_error() != 49077) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_build_with_qr_code() != 17628) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_matrix_sdk_ffi_checksum_constructor_qrcodedata_from_bytes() != 22720) {
        return InitializationResult.apiChecksumMismatch
    }
